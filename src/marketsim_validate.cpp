...
const char* side_name(market_sim::LobsterBookSide side) {
...
void print_summary(
    ...
    std::size_t depth,
    const market_sim::LobsterValidationSummary& summary
) {
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        auto summary = market_sim::validate_market_data_replay(
